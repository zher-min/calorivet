...
export default function Home() {
  return <main className="toolkit-workspace">
    <div className="toolkit-intro"><h1>VetCalc</h1><p className="toolkit-subtitle">Veterinary Clinical Calculators</p><p>Fast, practical calculators for veterinary clinical practice.</p></div>
