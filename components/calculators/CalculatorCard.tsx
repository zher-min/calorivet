...
export default function CalculatorCard({ calculator }: { calculator: Calculator }) {
  return <Link className="toolkit-card" href={calculator.route} aria-label={`Open ${calculator.brand} calculator`}>
    ...
    <span className="toolkit-open">Open Calculator <span aria-hidden="true">→</span></span>
  </Link>;
}
